...
//         var tolowertxt = surveyObject.Questions[i].Required_vod__c.toString();
//         tolowertxt = tolowertxt.toLowerCase();
//         if ((surveyObject.Questions[i].Required_vod__c == 1) || (surveyObject.Questions[i].Required_vod__c == '1') || (tolowertxt == 'true')) {
